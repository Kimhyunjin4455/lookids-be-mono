...
public class FavoriteReadController {
	...
	public BaseResponse<List<FavoriteResponseVo>> readUserFavoriteList(
	...
	public BaseResponse<List<FavoriteResponseVo>> readFeedFavoriteList(
		@RequestParam String targetCode,
		@RequestParam FavoriteType favoriteType,
	...
	@Operation(summary = "Read User Favorite Feed API", description = "하나의 피드/댓글에 대한 좋아요 여부 체크 API", tags = {
		"Favorite"})
	@GetMapping("feed")
	public BaseResponse<Boolean> readFavorite(
		@RequestHeader String uuid,
		@RequestParam String targetCode
	) {
