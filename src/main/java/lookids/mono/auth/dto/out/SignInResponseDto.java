...
public class SignInResponseDto {
	...
	public static SignInResponseDto toDto(String accessToken, String refreshToken, String uuid) {
		return SignInResponseDto.builder().accessToken(accessToken).refreshToken(refreshToken).uuid(uuid).build();
	}

	public SignInResponseVo toVo() {
		return SignInResponseVo.builder().accessToken(accessToken).refreshToken(refreshToken).uuid(uuid).build();
	}
