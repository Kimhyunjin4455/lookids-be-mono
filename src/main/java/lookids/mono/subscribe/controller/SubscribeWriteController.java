...
import lookids.mono.subscribe.vo.in.SubscribeRequestVo;
...
public class SubscribeWriteController {
	...
	@Operation(summary = "게시글 알림 신청 API", description = """
	...
	@PostMapping
	public BaseResponse<Void> createSubscribe(@RequestHeader String uuid,
	...
	@DeleteMapping
	public BaseResponse<Void> deleteSubscribe(@RequestHeader String uuid,
		@RequestBody SubscribeRequestVo subscribeRequestVo) {
