...
public class SubscribeResponseDto {
	...
	@Builder
	public SubscribeResponseDto(String authorUuid, List<String> subscriberUuids) {
	...
	public static SubscribeResponseDto toDto(String authorUuid, List<String> subscriberUuids) {
		return SubscribeResponseDto.builder().authorUuid(authorUuid).subscriberUuids(subscriberUuids).build();
	}

	public SubscribeResponseVo toVo() {
		return SubscribeResponseVo.builder().authorUuid(authorUuid).subscriberUuids(subscriberUuids).build();
	}
}
