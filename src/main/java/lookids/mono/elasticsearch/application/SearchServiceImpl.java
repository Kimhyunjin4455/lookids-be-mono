...
import lookids.elasticsearch.dto.in.KafkaFeedCreateRequestDto;
import lookids.elasticsearch.dto.in.KafkaFeedDeleteRequestDto;
import lookids.elasticsearch.dto.in.KafkaPetCreateRequestDto;
import lookids.elasticsearch.dto.in.KafkaPetDeleteRequestDto;
import lookids.elasticsearch.dto.in.KafkaPetUpdateRequestDto;
import lookids.elasticsearch.dto.in.KafkaUserCreateRequestDto;
import lookids.elasticsearch.dto.in.KafkaUserDeleteRequestDto;
import lookids.elasticsearch.dto.in.KafkaUserImageUpdateRequestDto;
import lookids.elasticsearch.dto.in.KafkaUserNicknameUpdateRequestDto;
...
public class SearchServiceImpl implements SearchService {
	...
	@KafkaListener(topics = "userprofile-create", groupId = "usercreate-group",
		containerFactory = "UserCreateContainerFactory")
	...
	@KafkaListener(topics = "userprofile-nickname-update", groupId = "usernicknameupdate-group",
		containerFactory = "UserNicknameUpdateContainerFactory")
	public void consumeUserNicknameUpdate(KafkaUserNicknameUpdateRequestDto kafkaUserNicknameUpdateRequestDto) {
		...
		kafkaBatchCollector.addUserUpdateBatch(KafkaUserNicknameUpdateRequestDto.toUpdateNickname(searchUser,
			kafkaUserNicknameUpdateRequestDto));

	}

	@KafkaListener(topics = "userprofile-image-update", groupId = "userimageupdate-group",
		containerFactory = "UserImageUpdateContainerFactory")
	public void consumeUserImageUpdate(KafkaUserImageUpdateRequestDto kafkaUserImageUpdateRequestDto) {
		...
		kafkaBatchCollector.addUserUpdateBatch(KafkaUserImageUpdateRequestDto.toUpdateImage(searchUser,
			kafkaUserImageUpdateRequestDto));

	}

	@KafkaListener(topics = "account-delete", groupId = "userdelete-group",
	...
	@KafkaListener(topics = "feed-create", groupId = "feedcreate-group",
		containerFactory = "FeedCreateContainerFactory")
	...
	@KafkaListener(topics = "feed-delete", groupId = "feeddelete-group",
		containerFactory = "FeedDeleteContainerFactory")
	...
	@KafkaListener(topics = "petprofile-create", groupId = "petcreate-group",
		containerFactory = "PetCreateContainerFactory")
	...
	@KafkaListener(topics = "petprofile-update", groupId = "petupdate-group",
		containerFactory = "PetUpdateContainerFactory")
	public void consumePetUpdate(KafkaPetUpdateRequestDto kafkaPetUpdateRequestDto) {
		...
		kafkaBatchCollector.addPetUpdateBatch(KafkaPetUpdateRequestDto
			.toUpdate(searchPet, kafkaPetUpdateRequestDto).toEntity());

	}

	@KafkaListener(topics = "petprofile-delete", groupId = "petdelete-group",
		containerFactory = "PetDeleteContainerFactory")
