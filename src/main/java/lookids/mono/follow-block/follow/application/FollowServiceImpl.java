...
import Lookids.follow.dto.in.KafkaFollowDto;
import Lookids.follow.dto.in.KafkaFollowRequestDto;
import Lookids.follow.dto.in.KafkaUserUpdateRequestDto;
import Lookids.follow.dto.out.FollowInfoResponseDto;
import Lookids.follow.dto.out.FollowResponseDto;
import Lookids.follow.dto.out.KafkaAlarmFollowResponseDto;
import Lookids.follow.dto.out.KafkaFollowResponseDto;
import Lookids.follow.dto.out.KafkaFollowerResponseDto;
import Lookids.follow.infrastructure.FollowInfoRepository;
import Lookids.follow.infrastructure.FollowRepository;
...
public class FollowServiceImpl implements FollowService {
	...
	@KafkaListener(topics = "follow-request", groupId = "feed-group",
		containerFactory = "FeedFollowListenerContainerFactory")
	...
	@KafkaListener(topics = "follower-request", groupId = "feed-group",
		containerFactory = "FollowerListenerContainerFactory")
	...
	@KafkaListener(topics = "userprofile-response", groupId = "feed-group",
		containerFactory = "FollowInfoContainerFactory")
	...
	@KafkaListener(topics = "userprofile-nickname-update", groupId = "es-group",
		containerFactory = "UserUpdateContainerFactory")
	...
	@KafkaListener(topics = "userprofile-image-update", groupId = "es-group",
		containerFactory = "UserUpdateContainerFactory")
